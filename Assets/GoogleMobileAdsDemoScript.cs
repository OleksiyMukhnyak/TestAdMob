...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        //                          0.8f * Screen.width, 0.1f * Screen.height);
        //if (GUI.Button(showBannerRect, "Request Native"))
        //{
        ...
        //                             0.8f * Screen.width, 0.1f * Screen.height);
        //if (GUI.Button(destroyBannerRect, "Show Native"))
        //{
        ...
        Rect requestRewardedRect = new Rect(0.1f * Screen.width, 0.175f * Screen.height,
                                       0.8f * Screen.width, 0.1f * Screen.height);
        ...
        Rect showRewardedRect = new Rect(0.1f * Screen.width, 0.05f * Screen.height,
                                    0.8f * Screen.width, 0.1f * Screen.height);
...
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-1026791870535825/4728701790";
    ...
    private void RequestInterstitial()
    {
            ...
            string adUnitId = "unused";
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-1026791870535825/4602447391";
#elif (UNITY_5 && UNITY_IOS) || UNITY_IPHONE
    ...
    private void RequestRewardBasedVideo()
    {
            ...
            string adUnitId = "unused";
#elif UNITY_ANDROID
            string adUnitId = "ca-app-pub-1026791870535825/6844563393";
#elif (UNITY_5 && UNITY_IOS) || UNITY_IPHONE
    ...
    public void HandleInterstitialLoaded(object sender, EventArgs args)
    {
        ...
        testText.text += " LoadedIn ";
    }

    public void HandleInterstitialFailedToLoad(object sender, AdFailedToLoadEventArgs args)
    {
        print("HandleInterstitialFailedToLoad event received with message: " + args.Message);
        testText.text += " FailedIn ";
    }

    public void HandleInterstitialOpened(object sender, EventArgs args)
    {
        print("HandleInterstitialOpened event received");
        testText.text += " OpenedIn ";
    }

    void HandleInterstitialClosing(object sender, EventArgs args)
    {
        print("HandleInterstitialClosing event received");
        testText.text += " ClosingdIn ";
    }

    public void HandleInterstitialClosed(object sender, EventArgs args)
    {
        print("HandleInterstitialClosed event received");
        testText.text += " ClosedIn ";
    }
    ...
    public void HandleRewardBasedVideoRewarded(object sender, Reward args)
    {
        ...
        testText.text += " Rewarded " + amount.ToString() + " " + type;
